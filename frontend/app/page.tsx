...
export default async function Home({
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      {jobs.length === 0 ? (
        <div className="flex flex-col items-center justify-center p-12 bg-white dark:bg-slate-900 rounded-lg border border-dashed border-slate-300 dark:border-slate-800">
